...
def main():
    ...
    pr(
        border,
        ".:::     Welcome to the Nahan Maskara cryptography task!      ::.",
        border,
    )
    pr(
        border,
        ".: Your mission is to find flag by analysing the Nahan Maskara :.",
        border,
    )
    pr("┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛")
    ...
    while True:
        ...
        if ans == "g":
            ...
            try:
                ...
                die(border, "The input you provided is not valid!")
            if _b:
                ...
                die(border, "Your input does not meet the requirements!!!")
        elif ans == "s":
