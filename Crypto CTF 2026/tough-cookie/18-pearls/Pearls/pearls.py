...
def burnish(skey, l):
    ...
    IRE = [
        [
            getRandomRange(0, 2),
            getRandomNBitInteger(nbit + getRandomRange(-3, 3)),
            getRandomNBitInteger(int(nbit * 0.74)),
        ]
        for _ in range(l)
    ]
...
def main():
    ...
    pr(
        border,
        ".::               Welcome to the Pearls challenge!            ::. ",
        border,
    )
    pr(
        border,
        " You should analyze this cryptosystem and break it to get the flag",
        border,
    )
    pr("┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛")
    nbit = 1024
    ...
    while True:
        ...
        if ans == "e":
            ...
            pr(
                border,
                "Please let me know how many times you want to burnish and burnish the key: ",
            )
            l = sc().decode().strip()
            try:
                l = int(l) % 5
