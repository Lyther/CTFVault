...
brackets_pairs = [("DFDE", "DCE"), ("DCE", "DFDE")]
other_chars = "><+-.,"

for b1, b2 in brackets_pairs:
    others = [c for c in unique_clusters if c not in (b1, b2)]
    for p in itertools.permutations(other_chars):
        mapping = {b1: "[", b2: "]"}
