...
print(f"Total AA pairs: {len(aa_pairs)}")
print(f"Unique AA pairs: {len(set(aa_pairs))}")

# Let's count the frequencies of AA pairs
print(collections.Counter(aa_pairs).most_common(10))
