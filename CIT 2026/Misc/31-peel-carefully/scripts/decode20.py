...
for perm in itertools.permutations(range(8)):
    ...
    if res.startswith(b"\x1f\x8b") or res.startswith(b"7z\xbc\xaf\x27\x1c") or res.startswith(b"\x50\x4b\x03\x04"):
        print(f"Found compressed file with mapping {mapping}")
        print(res[:20])
