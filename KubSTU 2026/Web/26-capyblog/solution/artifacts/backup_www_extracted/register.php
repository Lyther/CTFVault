...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (auth_register($username, $password, $error)) {
        // Пользователь автоматически залогинен внутри auth_register
...
<head>
    <meta charset="UTF-8">
    <title>Регистрация — <?= h(APP_NAME) ?></title>
    <style>
        :root {
            --accent: #4aa3ff;
            --accent2: #2f6bff;
...
<div class="box">
    ...
    <div class="links">
        Уже есть аккаунт? <a href="login.php">Войти</a><br>
